...
- This buildpack downloads wkhtmltopdf v0.12.6.1-3 for `heroku-24`, v0.12.6.1-2 for `heroku-22`, v0.12.6-1 for `heroku-20` stack and v0.12.5 for `heroku-18` stack.
